...
if (empty($_SESSION['name'])) {
  $host = $_SERVER['HTTP_HOST'];             // e.g., republicwing.com
...
<head>
  ...
  <title>Finance Flow by Republic Wing</title>
    ...
    <div class="w-72 bg-white shadow-lg p-4">
      <div class="p-4 gradient-card rounded-xl text-white mb-6">
        <div class="flex items-center space-x-3 mb-3">
          ...
          <div>
            <h1 class="text-xl font-bold">Finance Flow</h1>
      ...
      <div class="mb-6">
        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3 px-4">Reports</p>
        <div class="sidebar-item flex items-center px-4 py-3 mb-2 cursor-pointer transition-all duration-200">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <main class="flex-1 overflow-y-auto bg-gray-50 p-6">
        ...
        <div id="invoice-section" class="section active">
          ...
          <div class="flex justify-end mb-6">
            <button id="create-invoice-btn" class="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2 rounded-lg text-sm font-medium flex items-center transition-all duration-200 shadow-md hover:shadow-lg" id="create-invoice-btn">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 lg:col-span-2">
              ...
              <div class="h-64 relative">
                <svg class="w-full h-full" viewBox="0 0 800 300">
                  ...
                  <!-- Revenue Line -->
                  <path d="M108,180 L166,160 L224,170 L282,140 L340,150 L398,120 L456,130 L514,160 L572,130 L630,110 L688,100 L746,80"
                    class="chart-line" stroke="#6366f1" />

                  <!-- Revenue Area -->
                  <path d="M108,180 L166,160 L224,170 L282,140 L340,150 L398,120 L456,130 L514,160 L572,130 L630,110 L688,100 L746,80 L746,250 L108,250 Z"
                    class="chart-area" fill="#6366f1" />

                  <!-- Profit Line -->
                  <path d="M108,210 L166,190 L224,200 L282,180 L340,190 L398,160 L456,170 L514,200 L572,170 L630,150 L688,140 L746,120"
                    class="chart-line" stroke="#10b981" />

                  <!-- Profit Area -->
                  <path d="M108,210 L166,190 L224,200 L282,180 L340,190 L398,160 L456,170 L514,200 L572,170 L630,150 L688,140 L746,120 L746,250 L108,250 Z"
                ...
                <div class="relative w-48 h-48">
                  <svg class="w-full h-full" viewBox="0 0 100 100">
                    ...
                    <circle cx="50" cy="50" r="40" fill="none" stroke="#10b981" stroke-width="10"
                      stroke-dasharray="251.2 400" class="donut-chart" />

                    <!-- Pending Segment (25%) -->
                    <circle cx="50" cy="50" r="40" fill="none" stroke="#f59e0b" stroke-width="10"
                      stroke-dasharray="96.6 400" stroke-dashoffset="-251.2" class="donut-chart" />

                    <!-- Overdue Segment (10%) -->
                    <circle cx="50" cy="50" r="40" fill="none" stroke="#ef4444" stroke-width="10"
                      stroke-dasharray="38.6 400" stroke-dashoffset="-347.8" class="donut-chart" />
                  </svg>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
              ...
              <div class="space-y-4">
                <div class="flex items-center">
                  <div class="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-700 font-semibold text-xs mr-3">
                    SR
                  </div>
                  <div class="flex-1">
                ...
                <div class="flex items-center">
                  <div class="h-10 w-10 rounded-full bg-green-100 flex items-center justify-center text-green-700 font-semibold text-xs mr-3">
                    PS
                  </div>
                  <div class="flex-1">
                    <div class="flex justify-between">
                ...
                <div class="flex items-center">
                  <div class="h-10 w-10 rounded-full bg-purple-100 flex items-center justify-center text-purple-700 font-semibold text-xs mr-3">
                    SG
                  </div>
                  <div class="flex-1">
                    <div class="flex justify-between">
                ...
                <div class="flex items-center">
                  <div class="h-10 w-10 rounded-full bg-amber-100 flex items-center justify-center text-amber-700 font-semibold text-xs mr-3">
                    GS
                  </div>
                  <div class="flex-1">
                    <div class="flex justify-between">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 lg:col-span-2">
              <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex space-x-2">
                  <button class="px-3 py-1 border border-gray-300 rounded-lg text-xs font-medium text-gray-700 hover:bg-gray-50 flex items-center">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr class="hover:bg-gray-50 transition-colors">
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                          <div class="h-8 w-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-700 font-semibold text-xs">
                            SG
                          </div>
                          <div class="ml-3">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                          <div class="h-8 w-8 rounded-full bg-green-100 flex items-center justify-center text-green-700 font-semibold text-xs">
                            PS
                          </div>
                          <div class="ml-3">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                          <div class="h-8 w-8 rounded-full bg-purple-100 flex items-center justify-center text-purple-700 font-semibold text-xs">
                            SR
                          </div>
                          <div class="ml-3">
              ...
              <div class="mt-6 flex items-center justify-between">
                <div class="text-sm text-gray-700">
                  Showing <span class="font-medium">1</span> to <span class="font-medium">3</span> of <span class="font-medium">42</span> invoices
                </div>
